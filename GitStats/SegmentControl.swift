...
@IBDesignable class SegmentControl: UIControl {
    ...
    var colors: [UIColor] = [UIColor.blueColor(), UIColor.greenColor(), UIColor.yellowColor()] // default
    ...
    func displayNewSelectedIndex(){
        ...
        let underlineGrayBorderXstart = (UIScreen.mainScreen().bounds.width - CGRectGetWidth(self.bounds)) / 2
        let underlineGrayBorderYstart = thumbView.frame.size.height - 3
        let underlineGrayBorderHeight = CGFloat(3)
        let underlineGrayBorderWidth = CGRectGetWidth(self.bounds) + (2 * underlineGrayBorderXstart)
        
        underlineGrayBorder.frame = CGRectMake(-underlineGrayBorderXstart, underlineGrayBorderYstart, underlineGrayBorderWidth, underlineGrayBorderHeight)
        ...
        for (_, item) in labels.enumerate() {
            ...
            if item != labels.last {
                ...
                rightlineBorder.frame = CGRectMake(thumbView.frame.width - 2, 15, 1, item.intrinsicContentSize().height + 10)
        ...
        underlineBorder.frame = CGRectMake(0, thumbView.frame.size.height - 3, label.frame.width, 3)
